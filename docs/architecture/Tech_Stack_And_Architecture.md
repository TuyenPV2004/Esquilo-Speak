...
> Trạng thái triển khai: **Flutter mobile và Spring Boot modular monolith đã triển khai vertical slice đầu tiên theo ADR-002**
...
| Ngày | Thay đổi |
| --- | --- |
| 2026-07-28 | Chấp nhận Flutter, Java/Spring Modulith modular monolith và PostgreSQL; triển khai Foundation cùng vertical slice đầu tiên theo ADR-002. |
| 2026-07-16 | Chấp nhận REST/OpenAPI 3.1.1 và JSON Schema 2020-12 làm baseline contract theo ADR-001. |
