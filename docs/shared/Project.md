...
> Trạng thái triển khai: **Foundation và vertical slice học tập đầu tiên đã có mã nguồn, migration và test; chưa phải production release**

## 1. Mục đích tài liệu

Tài liệu này chi tiết hóa phần sản phẩm từ [tổng quan đề xuất EsquiloSpeak](Esquilo_Speak.md) và trả lời:
...
5. [Esquilo_Speak.md](Esquilo_Speak.md) để tham khảo tổng quan, không dùng thay cho quyết định chi tiết.
...
| Ngày | Thay đổi |
| --- | --- |
| 2026-07-16 | Chấp nhận vertical slice triển khai đầu tiên và liên kết tới content schema/OpenAPI tương ứng. |
| 2026-07-14 | Đổi vai trò từ “tài liệu chung” thành tài liệu chuyên biệt về phạm vi và mô hình sản phẩm. |
| 2026-07-14 | Đồng bộ vai trò của `Esquilo_Speak.md` và loại bỏ tham chiếu tới các thư mục tài liệu không tồn tại. |
